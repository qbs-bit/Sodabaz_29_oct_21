            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="bordered-layout-colored-controls">Add Products</h4>
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form class="form form-horizontal form-bordered" enctype="multipart/form-data" method="post" action="{{url('mills/save_product')}}">
                      @csrf
                     ...
                     <div class="form-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-md-4 label-control" for="category"> Select Category</label>
                              <div class="col-md-8">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row last">
                              <label class="col-md-4 label-control" for="product_code">Product Code</label>
                              <div class="col-md-8">
                              <input type="number" id="product_code" class="form-control" placeholder="Product Code" name="product_code">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-md-4 label-control" for="product_type">Product Type</label>
                              <div class="col-md-8">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-md-4 label-control" for="product_name">Product Name</label>
                              <div class="col-md-8">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row last">
                              <label class="col-md-4 label-control" for="dimensions">Dimensions</label>
                              <div class="col-md-8">
                              <input type="text" id="dimensions" class="form-control" placeholder="Dimensions" name="dimensions">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group row last">
                              <label class="col-md-4 label-control" for="per_unit_price">Per Unit Price</label>
                              <div class="col-md-8">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row last">
                              <label class="col-md-4 label-control" for="bidding">Bidding</label>
                              <div class="col-md-8">
                              <select id="is_bid" onchange="getbidstatus(this)" class="form-control" name="is_bid">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group row">
                            <label class="col-md-2 label-control" for="images">Product Images</label>
                              <div class="col-md-8">
                          ...
                          <div class="col-md-12">
                            <div class="form-group row last">
                              <label class="col-md-2 label-control" for="description">Product Description</label>
                              <div class="col-md-8">
