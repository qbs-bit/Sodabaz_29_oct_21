    ...
    <section class="hero hero-home no-padding">
      <div class="container-fluid p-0">       
        <div style="background: url({{asset('website-assets/img/Banner.png)')}};" class="item d-flex col-lg-12">
           <div class="container">
            <center>
           <h2 style="color: black;">PRODUCT ANNOUNCEMENTS</h2>
            </center>
          </div>
        </div>
    </div>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="block">
              ...
              <ul class="list-unstyled experiences">
                ...
                <li>
                  ...
                  <a href="{{url('website/product_announcements',$data->id)}}" class="fw-bold nohover mb-3">
                    {{$data->title}}
                  </a>
                </li>
                @endforeach
          ...
          <div class="products-grid col-lg-8 sidebar-left">
	      	<!-- item-->
	      	@foreach($single_product as $data)
	          <header>
	              <h3>
	              	{{$data->title}}
	              </h3>
