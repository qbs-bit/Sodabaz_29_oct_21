            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="bordered-layout-colored-controls">Product Announcements</h4>
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form class="form form-horizontal form-bordered" enctype="multipart/form-data" method="post" action="{{url('/save_productannouncements')}}">
                    	@csrf
